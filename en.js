...
function X_O(I) {
  ...
  if (content.innerHTML == "") {
    if (turn == "X") {
      ...
      XO = "O";
      document.getElementById("who").innerHTML = "<span id='in'>" + XO  + "</span> will play";
  ...
  if ((id("box1") == "X" && id("box2") == "X" && id("box3") == "X") || (id("box1") == "O" && id("box2") == "O" && id("box3") == "O")) {
    if (id("box1") == "X") {
      document.getElementById("who").innerHTML = "X wins";
    } else {
      document.getElementById("who").innerHTML = "O wins";
    }
  ...
  if (document.getElementById("who").innerHTML == "X wins") {
    ...
    document.getElementById("cong").innerHTML = "congratulation Mr./Ms. X";
    document.getElementById("blockresolt").style.display = "inline-block";
    document.getElementById("X").innerHTML = ++X;
    document.getElementById("X1").innerHTML = X;
  } else if (document.getElementById("who").innerHTML == "O wins") {
    ...
    document.getElementById("cong").innerHTML = "congratulation Mr./Ms. O";
    document.getElementById("blockresolt").style.display = "inline-block";
...
function restart() {
  ...
  document.getElementById("who").innerHTML = "<span id='in'>" + XO  + "</span> will start";
...
function rest() {
  ...
  O = 0;
  XO = "X";
  document.getElementById("who").innerHTML = "<span id='in' style='color: red;'>" + XO  + "</span> will start";
  document.getElementById("X1").innerHTML = X;
  document.getElementById("O1").innerHTML = O;
  document.getElementById("X").innerHTML = X;
  document.getElementById("O").innerHTML = O;
